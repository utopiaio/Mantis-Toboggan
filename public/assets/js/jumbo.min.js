...
(function (angular) {
  ...
  function ShowtimeController ($rootScope, $http, $location, $mdToast) {
    $rootScope.$on('$routeChangeSuccess', function (event, target) {
      ...
      if (target.$$route) {
        console.log(target.$$route.originalPath);
      } else {
        console.log('boot!');
      }
    });
