...
const typo = require('./../humans/typo');
  ...
  request
    ...
    .then((res) => {
      ...
      ednaMallCells.forEach((ednaMallCell) => {
        ...
        // Movie Title ((2|3)D) removed and trimmed AND typo fix
        const title = typo($('.showtimes-movie-detail [class*="heading"]', ednaMallCell).text().replace(/\((2|3)D\)/g, '').trim());
