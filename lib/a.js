      ...
      lw5Data.forEach((lw5Response, index) => {
        if (lw5Response !== null) {
          ...
          lw5Mapper[index].indices.forEach((lw5MapIndex) => {
            schedule[todayYYYYMMDD][lw5MapIndex.cinema][lw5MapIndex.index].title = lw5Response.name;
            schedule[todayYYYYMMDD][lw5MapIndex.cinema][lw5MapIndex.index].detail = lw5Response;
            schedule[todayYYYYMMDD][lw5MapIndex.cinema][lw5MapIndex.index].posterURL = lw5Response.poster;
          });
        }
      });

      resolve({
        show: schedule[todayYYYYMMDD],
        meta: {
