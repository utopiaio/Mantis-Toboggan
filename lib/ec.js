 ...
 * @return {Number}
 */
function copticToJDN(year = 1, month = 1, day = 1) {
...
function ethiopicMonthToFullEthiopicMonth(month) {
  const MMMM = ['መስከረም', 'ጥቅምት', 'ኅዳር', 'ታኅሣሥ', 'ጥር', 'የካቲት', 'መጋቢት', 'ሚያዝያ', 'ግንቦት', 'ሰኔ', 'ሐምሌ', 'ነሐሴ', 'ጳጉሜን'];

  return MMMM[month - 1] || null;
}

console.log(ethiopicToGregorian(2009, 13, 3), gregorianToEthiopic(2017, 9, 8));
